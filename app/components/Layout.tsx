...
import { FaBars, FaTimes, FaHome, FaUser, FaNewspaper, FaSignOutAlt, FaMapMarkerAlt, FaFileInvoice, FaLock, FaChartLine, FaBlogger, FaRocket } from 'react-icons/fa';
        ...
        <nav className="p-4">
          <ul className="space-y-2">
            ...
            <li>
              <Link 
                href="/career/crud" 
                className={`flex items-center p-3 rounded-lg transition-all ${pathname.includes('/career') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}`}
              >
                <FaRocket className="text-lg mr-3" />
